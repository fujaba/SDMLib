...
public class GraphIdMap extends IdMapEncoder
{
   ...
   {
      return parse(object, filter.clone(new GraphIdMapFilter()).withTyp(OBJECT));
   }
         ...
         Object item, String cardinality)
   {
      ...
      if (!filter
         .isPropertyRegard(this, entity, property, item, true, deep + 1))
      {
         return;
      }
      ...
      if (valueCreater != null)
      {
         ...
         list.addEdge(new GraphEdge().withSource(element).withTarget(subId,
