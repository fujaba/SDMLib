...
public class JsonIdComparator implements Comparator<Object>
{
   ...
   public int compare(Object o1, Object o2)
   {
      ...
      while (true)
      {
         ...
         else // two digits, compute the numbers and compare them
         {
            long num1 = c1;
            while (i1 + 1 <= lastIndex1 && Character.isDigit(id1.charAt(i1 + 1)))
            {
            ...
            long num2 = c2;
            while (i2 + 1 <= lastIndex2 && Character.isDigit(id2.charAt(i2 + 1)))
            {
