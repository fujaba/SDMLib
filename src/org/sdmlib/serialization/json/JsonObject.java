...
import org.sdmlib.serialization.ArrayMap;
...
public class JsonObject extends Entity implements LocalisationEntity
{
   ...
   public String toString(int indentFactor, int indent)
   {
      ...
      Iterator<String> iterator = map.keyList().iterator();
      ...
      sb.append(EntityUtil.quote(item));
      sb.append(":");
      ...
      while (iterator.hasNext())
      {
         ...
         sb.append(EntityUtil.quote(item));
         sb.append(":");
         sb.append(EntityUtil.valueToString(map.get(item), indentFactor,
