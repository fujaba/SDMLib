...
public class SDMLibIdMap extends IdMap {
  ...
  @Override
  public SendableEntityCreator getCreator(String clazz, boolean fullName, boolean caseSensitive, SimpleList<SendableEntityCreator> creators) {
    SendableEntityCreator result = super.getCreator(clazz, fullName, caseSensitive, creators);
