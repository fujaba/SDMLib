...
public class ReplicationObjectScenarioForCoverage
{
   ...
   /**
    * 
    * <h3>Storyboard ReplicationObjectScenarioForCoverage</h3>
    * <p>Create some objects just for coverage. This does not serve as an usage example.</p>
    * <img src="doc-files/ReplicationObjectScenarioForCoverageStep1.png" alt="ReplicationObjectScenarioForCoverageStep1.png">
    */
   @Test
   public void testReplicationObjectScenarioForCoverage()
   {
      ...
      story.addObjectDiagramViaGraphViz(replicationNode, replicationServer, serverSocketAcceptThread, remoteTaskBoard,
