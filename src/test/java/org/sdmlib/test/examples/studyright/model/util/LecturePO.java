...
public class LecturePO extends PatternObject<LecturePO, Lecture>
{
   ...
   {
      ProfessorPO result = new ProfessorPO(new org.sdmlib.test.examples.studyright.model.Professor[]{});
   ...
   {
      StudentPO result = new StudentPO(new org.sdmlib.test.examples.studyright.model.Student[]{});
