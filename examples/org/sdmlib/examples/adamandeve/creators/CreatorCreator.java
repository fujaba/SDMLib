...
public class CreatorCreator
{
   ...
   public static LinkedHashSet<SendableEntityCreator> getCreatorSet()
   {
      if (creatorSet == null)
      {
         ...
         creatorSet
            .add(new org.sdmlib.examples.adamandeve.creators.EveCreator());
         creatorSet
            .add(new org.sdmlib.examples.adamandeve.creators.EvePOCreator());
         creatorSet
            .add(new org.sdmlib.examples.adamandeve.creators.AdamCreator());
         creatorSet
            .add(new org.sdmlib.examples.adamandeve.creators.AdamPOCreator());
         // creatorSet.add(new
         // org.sdmlib.model.taskflows.creators.TaskFlowCreator());
         // creatorSet.add(new
         // org.sdmlib.model.taskflows.creators.TaskFlowPOCreator());
         creatorSet
         ...
         creatorSet
            .add(new org.sdmlib.examples.adamandeve.creators.UpdateAdamFlowCreator());
         creatorSet
            .add(new org.sdmlib.examples.adamandeve.creators.UpdateAdamFlowPOCreator());
         creatorSet
         ...
         creatorSet
            .addAll(new org.sdmlib.model.taskflows.creators.CreatorCreator()
               .getCreatorSet());
