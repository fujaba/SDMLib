...
public class DataPO extends PatternObject<DataPO, Data>
{
   ...
   public DataPO hasNum(int value)
   {
      AttributeConstraint constr = (AttributeConstraint) new AttributeConstraint()
         .withAttrName(Data.PROPERTY_NUM).withTgtValue(value).withSrc(this)
   ...
   {
      AttributeConstraint constr = (AttributeConstraint) new AttributeConstraint()
         .withAttrName(Data.PROPERTY_FXNUM).withTgtValue(value).withSrc(this)
         .withModifier(this.getPattern().getModifier())
         .withPattern(this.getPattern());
   ...
   {
      AttributeConstraint constr = (AttributeConstraint) new AttributeConstraint()
         .withAttrName(Data.PROPERTY_NUM).withTgtValue(lower)
