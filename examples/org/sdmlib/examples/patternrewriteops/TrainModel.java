...
public class TrainModel
{
   ...
   public void makeModel()
   {
      ...
      Clazz stationClass = trainClass.createClassAndAssoc("Station", "station",
         R.ONE, "trains", R.MANY);

      stationClass.withAssoc(stationClass, "next", R.ONE, "prev", R.ONE);

      Clazz personClass = stationClass.createClassAndAssoc("Person", "people",
         R.MANY, "station", R.ONE);

      trainClass.withAssoc(personClass, "passengers", R.MANY, "train", R.ONE);

      stationClass.createClassAndAssoc("SignalFlag", "flag", R.ONE, "station",
         R.MANY);
