...
public class RoomCreator extends EntityFactory
{
   ...
   { Room.PROPERTY_NAME, Room.PROPERTY_TOPIC, Room.PROPERTY_CREDITS,
         Room.PROPERTY_UNIVERSITY, Room.PROPERTY_DOORS, Room.PROPERTY_STUDENTS,
         Room.PROPERTY_ASSIGNMENTS, Room.PROPERTY_TAS, };
