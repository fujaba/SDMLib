...
public class CreatorCreator
{
   ...
   public static LinkedHashSet<SendableEntityCreator> getCreatorSet()
   {
      if (creatorSet == null)
      {
         ...
         creatorSet.add(new org.sdmlib.examples.studyrightWithAssignments.creators.UniversityCreator());
         creatorSet.add(new org.sdmlib.examples.studyrightWithAssignments.creators.UniversityPOCreator());
         creatorSet.add(new org.sdmlib.examples.studyrightWithAssignments.creators.StudentCreator());
         creatorSet.add(new org.sdmlib.examples.studyrightWithAssignments.creators.StudentPOCreator());
         creatorSet.add(new org.sdmlib.examples.studyrightWithAssignments.creators.RoomCreator());
