...
import org.sdmlib.examples.ludo.model.creators.PlayerSet;
...
public class PlayerPO extends PatternObject<PlayerPO, Player>
{
   ...
   public PlayerPO hasEnumColor(Point value)
   {
      AttributeConstraint constr = (AttributeConstraint) new AttributeConstraint()
   ...
   public PlayerPO createEnumColor(Point value)
   {
      this.startCreate().hasEnumColor(value).endCreate();
      return this;
   }
   
   public Point getEnumColor()
   {
      if (this.getPattern().getHasMatch())
      {
   ...
   public PlayerPO withEnumColor(Point value)
   {
      if (this.getPattern().getHasMatch())
      {
