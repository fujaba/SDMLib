...
public class NodeCreator extends EntityFactory
{
   ...
   { Node.PROPERTY_NAME, Node.PROPERTY_GRAPH, Node.PROPERTY_OUTEDGES,
         Node.PROPERTY_INEDGES, Node.PROPERTY_ORIG, Node.PROPERTY_COPY,
         GraphComponent.PROPERTY_TEXT, Node.PROPERTY_LINKSTO,
         Node.PROPERTY_LINKSFROM, GraphComponent.PROPERTY_PARENT, };
