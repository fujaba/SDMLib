...
public class ReachbilityGraphFerrymansProblemExample
{
   ...
   public void FerrymansProblemExample()
   {
      ...
      // ================================================
      // load boat rule
      ModelPattern loadPattern = (ModelPattern) new ModelPattern()
         .withName("load");
      ...
      CargoPO goatPO = bankPO.startNAC().hasCargos().hasName("goat")
         .hasMatchOtherThen(cargoPO);
      ...
      // ================================================
      // move boat rule
      ModelPattern movePattern = (ModelPattern) new ModelPattern()
         .withName("move");
