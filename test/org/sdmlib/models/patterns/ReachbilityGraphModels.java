...
public class ReachbilityGraphModels
{
   ...
   public void SimpleReachabilityGraphModel()
   {
      ...
      Clazz node = state.createClassAndAssoc("Node", "nodes", R.MANY, "graph", R.ONE)
            .withAttributes("num", R.INT);
   ...
   public void FerryMansProblemModel()
   {
      ...
      Clazz boat = river.createClassAndAssoc("Boat", "boat", R.ONE, "river", R.ONE);
      
      Clazz bank = boat.createClassAndAssoc("Bank", "bank", R.ONE, "boat", R.ONE)
            .withAttributes("name", R.STRING, "age", "int");
      
      river.withAssoc(bank, "banks", R.MANY, "river", R.ONE);
      
      Clazz cargo = bank.createClassAndAssoc("Cargo", "cargos", R.MANY, "bank", R.ONE)
            .withAttribute("name", R.STRING);
