...
public class TemplateGrammarTest
{
   ...
   public void testTemplateGrammarTest()
   {
      ...
      Template uniTemplate = new Template().withName("UniTemplate").withModelClassName(University.class.getName())
      .with("Uni name has some students:\nStudentList", 
         "name", University.PROPERTY_NAME);
      
      uniTemplate.getPlaceholders().first().withPrefix("Uni ");
      
      Template studentTemplate = uniTemplate.createPlaceHolderAndSubTemplate("StudentList", University.PROPERTY_STUDENTS, "name matrikelnummer", "", "\n", "\n").withName("StudentTemplate")
      .withReplacements(
         "name", Student.PROPERTY_NAME, 
         "matrikelnummer", Student.PROPERTY_MATRNO);
      ...
      Template templateListTemplate = new Template().withName("templateListTemplate").withModelObject(uniTemplate)
      .with(
         "class className \n" +
         "placeholderList", 
         "className", Template.PROPERTY_MODELCLASSNAME);
      
      templateListTemplate.createPlaceHolderAndSubTemplate("placeholderList", Template.PROPERTY_PLACEHOLDERS, 
         "const<<name", "", ">>", ">>")
         .withReplacements(
            "const", PlaceHolderDescription.PROPERTY_PREFIX,
