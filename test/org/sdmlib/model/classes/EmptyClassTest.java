...
public class EmptyClassTest
{
   ...
   public void testEmptyClass()
   {
      ...
      storyboard.addSVGImage(model.dumpClassDiagram("test",
         "EmptyClassTestClasses01"));

      NoProperties noPropertiesObj = new NoProperties();

      storyboard.addObjectDiagram(
         org.sdmlib.model.classes.test.creators.CreatorCreator
            .createIdMap("test"), noPropertiesObj);

      storyboard.add(
         "Simple object without properties creates object diagram,  now",
