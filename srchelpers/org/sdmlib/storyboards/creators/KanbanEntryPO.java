...
public class KanbanEntryPO extends PatternObject<KanbanEntryPO, KanbanEntry>
{
   public LogEntryPO hasLogEntries()
   {
      ...
      PatternLink patternLink = new PatternLink().withTgt(result)
         .withTgtRoleName(KanbanEntry.PROPERTY_LOGENTRIES).withSrc(this);
   ...
   public KanbanEntryPO withLogEntries(LogEntryPO tgtPO)
   {
      ...
      {
         ((KanbanEntry) this.getCurrentMatch()).withLogEntries((LogEntry) tgtPO
            .getCurrentMatch());
      }
      return this;
   }
   ...
   public KanbanEntryPO withoutLogEntries(LogEntryPO tgtPO)
   {
      if (this.getPattern().getHasMatch())
      {
         ((KanbanEntry) this.getCurrentMatch())
            .withoutLogEntries((LogEntry) tgtPO.getCurrentMatch());
      }
      return this;
   }
   ...
   {
      AttributeConstraint constr = (AttributeConstraint) new AttributeConstraint()
         .withAttrName(KanbanEntry.PROPERTY_PHASES).withTgtValue(value)
   ...
   {
      AttributeConstraint constr = (AttributeConstraint) new AttributeConstraint()
         .withAttrName(KanbanEntry.PROPERTY_PHASES).withTgtValue(lower)
