...
public class PatternLinkCreator extends EntityFactory
{
   ...
   { PatternLink.PROPERTY_SRCROLENAME, PatternLink.PROPERTY_TGTROLENAME,
         PatternLink.PROPERTY_TGT, PatternLink.PROPERTY_SRC,
         PatternLink.PROPERTY_HOSTGRAPHSRCOBJECT,
         PatternElement.PROPERTY_PATTERN, PatternLink.PROPERTY_MODIFIER,
         PatternLink.PROPERTY_HASMATCH, PatternLink.PROPERTY_PATTERNOBJECTNAME,
