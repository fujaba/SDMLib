...
public class NegativeApplicationConditionCreator extends EntityFactory
{
   ...
   { NegativeApplicationCondition.PROPERTY_HASMATCH, Pattern.PROPERTY_ELEMENTS,
         ...
         PatternElement.PROPERTY_DOALLMATCHES, Pattern.PROPERTY_DEBUGMODE,
         PatternElement.PROPERTY_PATTERN, Pattern.PROPERTY_TRACE,
         Pattern.PROPERTY_RGRAPH, Pattern.PROPERTY_NAME, };
