...
public class MatchCreator extends EntityFactory
{
   ...
   { Match.PROPERTY_STARTPOS,
         ...
         Match.PROPERTY_MATCHTEXT, Match.PROPERTY_MODELOBJECT,
         Match.PROPERTY_TEMPLATE, Match.PROPERTY_PLACEHOLDER,
         Match.PROPERTY_SUBMATCHES, Match.PROPERTY_PARENTMATCH, };
