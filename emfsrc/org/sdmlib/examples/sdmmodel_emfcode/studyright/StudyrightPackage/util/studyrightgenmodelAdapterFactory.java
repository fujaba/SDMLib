 ...
 * @generated
 */
public class studyrightgenmodelAdapterFactory extends AdapterFactoryImpl
{
   /**
    ...
    * @generated
    */
   public studyrightgenmodelAdapterFactory()
   {
    ...
    * @generated
    */
   protected studyrightgenmodelSwitch modelSwitch =
      new studyrightgenmodelSwitch()
      {
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.sdmlib.examples.sdmmodel_emfcode.studyright.StudyrightPackage.University <em>University</em>}'.
    * <!-- begin-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.sdmlib.examples.sdmmodel_emfcode.studyright.StudyrightPackage.Person <em>Person</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.sdmlib.examples.sdmmodel_emfcode.studyright.StudyrightPackage.Student <em>Student</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
...
} //studyrightgenmodelAdapterFactory
