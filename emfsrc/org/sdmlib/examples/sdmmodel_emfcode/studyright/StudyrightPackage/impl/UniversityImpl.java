 ...
 * <ul>
 *   <li>{@link org.sdmlib.examples.sdmmodel_emfcode.studyright.StudyrightPackage.impl.UniversityImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.sdmlib.examples.sdmmodel_emfcode.studyright.StudyrightPackage.impl.UniversityImpl#getStudents <em>Students</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UniversityImpl extends EObjectImpl implements University
{
   ...
   {
      return studyrightgenmodelPackage.Literals.UNIVERSITY;
   }
   ...
   public void setName(String newName)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, studyrightgenmodelPackage.UNIVERSITY__NAME, oldName, name));
   }
   ...
   public EList getStudents()
   {
      if (students == null)
      {
         students = new EObjectWithInverseResolvingEList(Student.class, this, studyrightgenmodelPackage.UNIVERSITY__STUDENTS, studyrightgenmodelPackage.STUDENT__UNI);
      }
      return students;
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
   {
      switch (featureID)
      {
         case studyrightgenmodelPackage.UNIVERSITY__STUDENTS:
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType)
   {
      switch (featureID)
      {
         case studyrightgenmodelPackage.UNIVERSITY__NAME:
            return getName();
         case studyrightgenmodelPackage.UNIVERSITY__STUDENTS:
            return getStudents();
      }
