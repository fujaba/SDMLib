...
import org.sdmlib.examples.sdmmodel_emfcode.studyright.StudyrightPackage.Person;
...
import org.sdmlib.examples.sdmmodel_emfcode.studyright.StudyrightPackage.studyrightgenmodelFactory;
 ...
 * @generated
 */
public class studyrightgenmodelPackageImpl extends EPackageImpl implements studyrightgenmodelPackage
{
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    ...
    * @see org.sdmlib.examples.sdmmodel_emfcode.studyright.StudyrightPackage.studyrightgenmodelPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private studyrightgenmodelPackageImpl()
   {
      super(eNS_URI, studyrightgenmodelFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link studyrightgenmodelPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static studyrightgenmodelPackage init()
   {
      if (isInited) return (studyrightgenmodelPackage)EPackage.Registry.INSTANCE.getEPackage(studyrightgenmodelPackage.eNS_URI);

      // Obtain or create and register package
      studyrightgenmodelPackageImpl thestudyrightgenmodelPackage = (studyrightgenmodelPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof studyrightgenmodelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new studyrightgenmodelPackageImpl());

      isInited = true;

      // Create package meta-data objects
      thestudyrightgenmodelPackage.createPackageContents();

      // Initialize created meta-data
      thestudyrightgenmodelPackage.initializePackageContents();

      // Mark meta-data to indicate it can't be changed
      thestudyrightgenmodelPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(studyrightgenmodelPackage.eNS_URI, thestudyrightgenmodelPackage);
      return thestudyrightgenmodelPackage;
   }
    ...
    * @generated
    */
   public studyrightgenmodelFactory getstudyrightgenmodelFactory()
   {
      return (studyrightgenmodelFactory)getEFactoryInstance();
   }
